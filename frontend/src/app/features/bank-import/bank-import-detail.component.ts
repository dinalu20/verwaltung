...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, MatCardModule, MatTableModule, MatButtonModule, MatIconModule, MatSelectModule, MatFormFieldModule, MatInputModule, NgIf, NgFor, NgClass],
  template: `
    ...
    <mat-card *ngIf="importData">
      <mat-card-content>
        <table mat-table [dataSource]="importData.lines || []" class="full-width">
          ...
          <ng-container matColumnDef="text"><th mat-header-cell *matHeaderCellDef>Buchungstext</th><td mat-cell *matCellDef="let l" style="max-width:300px">{{ l.bookingText }}</td></ng-container>
          ...
          <ng-container matColumnDef="match"><th mat-header-cell *matHeaderCellDef>Vorschlag</th><td mat-cell *matCellDef="let l">
            ...
            <span *ngIf="!l.suggestedMemberName" style="color:#999">-</span>
          </td></ng-container>
